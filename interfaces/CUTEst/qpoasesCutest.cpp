...
int main( )
{
    ...
    //opts.initialStatusBounds =  ST_LOWER;
    ...
    opts.enableWorkingSetRepair = BT_TRUE;
    ...
    /// \todo I don't trust passing initial values yet
    //for( int k=0; k<nVar; k++ )
    //{
        //xOpt[k] = xInit[k];
        //yOpt[k] = 0.0;
    ...
    ret = qpDense.init( H_d, g, A_d, lb, ub, lbA, ubA, nWSR, &time );
    ...
    ret = qpSparse.init( H_s, g, A_s, lb, ub, lbA, ubA, nWSR, &time );
