...
int main( )
{
	...
	real_t xOpt[2] = {1, 2}; // TODO remove init once getXSolution implemented
	real_t yOpt[2+1] = {3, 4, 5}; // TODO remove init once getXSolution implemented
