...
Recently, a couple of numerical modifications (as proposed in [4], [5]) have 
been introduced that greatly increase qpOASES's reliability when solving
...
[5] H.J. Ferreau, C. Kirches, A. Potschka, H.G. Bock, M. Diehl. qpOASES: 
A parametric active-set algorithm for quadratic programming. Mathematical 
Programming Computation, 2014 (in print).
